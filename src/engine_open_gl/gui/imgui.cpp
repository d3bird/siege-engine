...
/*
 ...
 - A minimal application skeleton may be:
     ...
     while (true)
     {
        ...
        MyGameUpdate(); // may use any ImGui functions, e.g. ImGui::Begin("My window"); ImGui::Text("Hello, engine!"); ImGui::End();
 ...
 A: When loading a font, pass custom Unicode ranges to specify the glyphs to load. 
      ...
      builder.AddText("Hello engine");                        // Add a string (here "Hello engine" contains 7 unique characters)
