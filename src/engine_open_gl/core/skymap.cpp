...
void skymap::init() {
    ...
    {
       paths.get_textures_loc("skybox/right.jpg"),
        paths.get_textures_loc("skybox/left.jpg"),
        paths.get_textures_loc("skybox/top.jpg"),
        paths.get_textures_loc("skybox/bottom.jpg"),
        paths.get_textures_loc("skybox/front.jpg"),
        paths.get_textures_loc("skybox/back.jpg")
    };
    std::vector<std::string> faces
    {
        paths.get_textures_loc("skybox/night_sky/right.png"),
       paths.get_textures_loc ("skybox/night_sky/left.png"),
        paths.get_textures_loc("skybox/night_sky/top.png"),
       paths.get_textures_loc ("skybox/night_sky/bottom.png"),
       paths.get_textures_loc ("skybox/night_sky/front.png"),
      paths.get_textures_loc  ("skybox/night_sky/back.png")
    };
    std::vector<std::string> nebula
    {
       paths.get_textures_loc ("skybox/nebula/nebula_right.jpg"),
       paths.get_textures_loc ("skybox/nebula/nebula_left.jpg"),
        paths.get_textures_loc("skybox/nebula/nebula_top.jpg"),
       paths.get_textures_loc ("skybox/nebula/nebula_bottom.jpg"),
       paths.get_textures_loc ("skybox/nebula/nebula_front.jpg"),
       paths.get_textures_loc ("skybox/nebula/nebula_back.jpg")
    };
